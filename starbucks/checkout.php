...
<div class="cart-container">
    ...
    if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])): ?>
        <form action="confirm_order.php" method="post"> <!-- Change the action to your confirmation page -->
            <table>
                <tr>
                    <th>Item</th>
                    <th>Price</th>
                ...
                <?php foreach ($_SESSION['cart'] as $cartItem): ?>
                    <tr>
                        <td class="cart-item-name"><?php echo htmlspecialchars($cartItem['item']); ?></td>
                        <td class="cart-item-price">₹ <?php echo htmlspecialchars($cartItem['price']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
            <button type="button" class="confirm-btn" onclick="redirectToPayment()">Confirm Order</button>
